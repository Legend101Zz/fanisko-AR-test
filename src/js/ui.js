...
$(document).ready(function () {
  let _resData;
  $.ajax({
    url: "https://d1u2maujpzk42.cloudfront.net/icc-scores/8d2b1e05-bf82-4a64-b49c-999a7b379092/player.json",
    type: "GET",
  ...
  var runData = [
    { run: 1, color: "white", id: "Ones" },
    { run: 2, color: "yellow", id: "Twos" },
...
const playersRunDetails = (_playerId) => {
  $.ajax({
    url: `https://d1u2maujpzk42.cloudfront.net/icc-scores/8d2b1e05-bf82-4a64-b49c-999a7b379092/${_playerId}.json`,
    type: "GET",
    success: function (res) {
      const _resData = res;
      console.log(_resData);
